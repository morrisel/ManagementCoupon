...
public class AtestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//
			// /*
			// * My Db Doesn't work with auto increment
			// */
			company1.setId(1);
...
//			 af.updateCustomer(customer2);
			...
			//
			 ...
			 coupon1.setEndDate(Date.valueOf("2016-07-27"));
			 coupon1.setAmount(3);
			 ...
			 coupon2.setEndDate(Date.valueOf("2016-07-27"));
			 coupon2.setAmount(3);
			 ...
			 coupon4.setEndDate(Date.valueOf("2016-07-29"));
			 coupon4.setAmount(3);
			 ...
			 coupon5.setEndDate(Date.valueOf("2016-07-30"));
			 coupon5.setAmount(3);
...
//			 cf.createCoupon(coupon5);
			...
			// ================================================================
			 ...
			 coupon2.setEndDate(Date.valueOf("2016-08-02"));
			 coupon2.setAmount(3);
			 ...
			 coupon4.setAmount(3);
			 coupon4.setType(CouponType.RESTAURANT);
			 ...
			 coupon5.setAmount(3);
			 coupon5.setType(CouponType.RESTAURANT);
...
//			 cf.updateCoupon(coupon5);
			...
			// ================================================================
			// System.out.println("=====================================================");
			 //System.out.println(cf.getCouponByType(CouponType.SPORTS));
//			 cf.getCouponByType(CouponType.CAMPING);
//			 cf.getCouponByType(CouponType.CAMPING);
			 cf.getCouponByType(CouponType.CAMPING);
